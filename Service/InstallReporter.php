<?php
/**
 * Standalone install + heartbeat reporter for Panth_HtmlSitemap.
 *
...
namespace Panth\HtmlSitemap\Service;
...
class InstallReporter
{
    ...
    public const MAGENTO_MODULE = 'Panth_HtmlSitemap';

    /** Composer package name reported to the receiver. */
    public const COMPOSER_PACKAGE = 'mage2kishan/module-html-sitemap';
